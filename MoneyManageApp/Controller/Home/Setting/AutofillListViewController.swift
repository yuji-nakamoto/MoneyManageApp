//
//  AutofillListViewController.swift
//  MoneyManageApp
//
...
class AutofillListViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        fetchAuto()
        navigationController?.navigationBar.shadowImage = UIImage(named: "line_view")
    }
...
extension AutofillListViewController: UITableViewDelegate, UITableViewDataSource {
