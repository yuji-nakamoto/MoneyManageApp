//
//  RestoreTutorialViewController.swift
//  MoneyManageApp
//
...
class RestoreTutorialViewController: UIViewController {
    ...
    @IBOutlet weak var startButtonTopConst: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        case 1334:
            ...
            startButtonTopConst.constant = 15
            break
        default:
            break
        }
    ...
    private func setVideoPlayer() {
        ...
        guard let path = Bundle.main.path(forResource: "restore", ofType: "mp4") else {
